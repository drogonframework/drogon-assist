 ...
 */
void store64(uint8_t* dst, uint64_t w)
{
#if defined(NATIVE_LITTLE_ENDIAN)
 ...
 */
void blake2b_update(blake2b_state* state, const unsigned char* input_buffer, size_t inlen)
{
 ...
 */
void blake2b_init(blake2b_state* state, size_t outlen, const void* key, size_t keylen)
{
    blake2b_param P = {0};
    const uint8_t* p;
    size_t i;
...
void blake2b_final(blake2b_state* state, void* out, size_t outlen)
{
 ...
 */
void blake2b(void* output, size_t outlen, const void* input, size_t inlen, const void* key, size_t keylen)
{
